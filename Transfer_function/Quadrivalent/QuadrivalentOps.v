(* QuadrivalentOps.v - Computational transfer functions for the Quadrivalent
...
Definition refine_bottom a := if Quadrivalent.equiv a QBottom then None else Some QBottom.
Definition refine_true a := if Quadrivalent.equiv a QTrue then None else Some QTrue.
Definition refine_false a := if Quadrivalent.equiv a QFalse then None else Some QFalse.
