...
(* STATUS: the known-bits domain (must0, must1).
   ...
   add (Z.add) : sound + best              sub (Z.sub) : sound + best
     (kb_add_sound / kb_add_best, kb_sub_sound / kb_sub_best)

   Transfer functions already split out into Transfer_function/KnownBits/:
   lor, land, lxor : sound + exact       BitwiseTheory.v
   add: negative precision results       AddTheory.v
     (NOT γ-exact, NOT α-complete) *)
